    ...
    return (
        ...
        <div className="w-100 p-2 flex">
            ...
            <div className="m-10 flex-1">
                <label name="first" className="w-100 mx-4 text-gray-900 text-opacity-50">První osoba
                ...
                <label name="second" className="w-100 mx-0 text-gray-900 text-opacity-50">Druhá osoba
