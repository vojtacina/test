    ...
    return (
        <div className=" bg-white pb-16">
                <div className="pb-6 pt-24 container mx-auto px-24">
                    <h2 className="text-6xl font-bold font-serif text-primary bg-clip-text text-transparent bg-gradient-to-r from-black to-yellow-800 mb-4">Test kompatibility partnerů</h2>
